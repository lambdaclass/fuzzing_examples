...
$_ZN6probe45probe17h17555576140a3688E = comdat nodeduplicate

$sancov.module_ctor_trace_pc_guard = comdat any

@__sancov_lowest_stack = external thread_local(initialexec) global i64
@__sancov_gen_ = private global [1 x i32] zeroinitializer, section "__sancov_guards", comdat($_ZN6probe45probe17h17555576140a3688E), align 4
...
define void @_ZN6probe45probe17h17555576140a3688E() unnamed_addr #0 comdat {
"_ZN66_$LT$i32$u20$as$u20$core..ops..arith..AddAssign$LT$$RF$i32$GT$$GT$10add_assign17hb2db32252bd11a23E.exit":
...
attributes #0 = { nonlazybind uwtable "target-cpu"="generic" "target-features"="+neon,+fp-armv8,+crypto,+crc,+outline-atomics" }
